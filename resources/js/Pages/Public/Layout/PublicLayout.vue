<template>
    <div class="flex">
        ...
        <div class="w-full ">
            <div class="flex justify-end bg-black text-white h-20 gap-x-10 sticky top-0 z-10">
                <div class="ml-5 my-auto">
                    <search></search>
                </div>
                <div class="flex justify-end my-auto mr-10">
                    <div class="hover:bg-zinc-800 hover:rounded-xl p-2">
                        <img class="h-8" src="/icons/i_login.svg">
                    </div>
                </div>
            </div>
            <main class="">
            ...
            <footer class="bg-black col-span-6 p-4 grid grid-cols-3 gap-6  fixed
             inset-x-0
             bottom-0">
...
import Sidebar from "@/Pages/Public/Layout/Sidebar/Sidebar.vue";
